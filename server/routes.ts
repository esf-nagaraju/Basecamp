  ...
  app.get('/api/tasks', isAuthenticated, async (req: any, res) => {
    try {
      ...
      const filters = {
        ...
        criteria: req.query.criteria ? (Array.isArray(req.query.criteria) ? req.query.criteria : [req.query.criteria]) : undefined,
        team: req.query.team ? (Array.isArray(req.query.team) ? req.query.team : [req.query.team]) : undefined,
        claimNumber: req.query.claimNumber ? (Array.isArray(req.query.claimNumber) ? req.query.claimNumber : [req.query.claimNumber]) : undefined,
        riskScore: req.query.riskScore ? (Array.isArray(req.query.riskScore) ? req.query.riskScore : [req.query.riskScore]) : undefined,
        payor: req.query.payor ? (Array.isArray(req.query.payor) ? req.query.payor : [req.query.payor]) : undefined,
        limit: req.query.limit ? parseInt(req.query.limit as string) : 50,
        offset: req.query.offset ? parseInt(req.query.offset as string) : 0,
      };
  ...
  app.get('/api/task-metadata', isAuthenticated, async (req: any, res) => {
    try {
      res.json({
        ...
        actionCategories: [
          'Status check',
          'Payment - To be Posted',
          'Resubmit'
        ],
        actionStatuses: {
          'Status check': [
            'Appeal: Appeal In Process - 1',
            'Appeal: Appeal In Process - 2',
            'No Action Taken: Claim In Process',
            'No Action Taken: Claim Paid but EOB Not Received',
            'Escalated To Onshore - Coding Review Needed',
            'Escalated To Onshore - Credentialing Issues',
            'Escalated To Onshore - Missing Medical Records',
            'Escalated To Onshore - Needs Appeal',
            'Escalated to Onshore - Patient Calling',
            'Patient balance: Applied to Deductible/Copay/Co-Ins',
            'Patient balance: Ins pymt sent to member',
            'Payment to be Posted',
            'Payment to be Posted: Partial Payment',
            'Write Off: Eligibility',
            'Write Off: Missing/Expired Authorization',
            'Write Off: Non Billable Procedure or Non Covered Code',
            'Write Off: Non-Credentialed Provider',
            'Write Off: Timely Filing',
            'No Action Taken: Escalated To Onshore - Incorrect Check Issue address and cashed',
            'Escalated To Onshore - Primary Medicare EOB Needed.',
            'Patient Balance: No OON Benefit',
            'Patient Balance: Inactive Insurance',
            'Reprocessing: Check reissued',
            'Escalated To Posting - Incorrect Check Issue address and cashed',
            'Reprocessing: Incorrectly processed/Denied',
            'Escalated To Onshore - Unable to Obtain Remit',
            'Paid Claim: Pending Payment due to EFT Issue',
            'Billed to patient',
            'Pending Insurance Follow up',
            'Letter Sent to Patient',
            'Adjustment Taken (Based on Guideline)',
            'Sent to Posting Team',
            'Self Pay: No Active Insurance',
            'Self Pay: Non-covered under plan benefit',
            'Self Pay: Other Insurance Primary',
            'Write Off: Duplicate',
            'Escalated to Onshore: To Update Payer',
            'Escalated to Onshore : Hospice/SNF',
            'Escalated to Onshore : Referral Needed',
            'Escalated to Onshore : New Insurance Info Needed'
          ],
          'Payment - To be Posted': [
            'No Action Taken: Payment Posted Prior to Status Check',
            'Claim Completed/Settled'
          ],
          'Resubmit': [
            'Reprocessing: Coding Related Denial',
            'Reprocessing: Credentialing Issues',
            'Reprocessing: Missing Authorization',
            'Reprocessing: Pmt Released but Never Received',
            'Reprocessing: Underpayment',
            'Resubmission :Claim on file - Coding Issue Fixed',
            'Resubmission: Claim Filed with POTF',
            'Resubmission: Claim Not on File - All Info Correct',
            'Resubmission: Claim Not on File - Demographics Fixed',
            'Resubmission: Claim Not on File - Insurance Info Fixed',
            'Resubmission: Claim Not on File - Paper Claim Sent',
            'Resubmission: Claim On File - Missing Insurance Info',
            'Resubmission: Claim On File - Missing Medical Records',
            'Resubmission: Denial - Credentialing Issues',
            'Resubmission: Denial - Sent Appeal 1',
            'Resubmission: Denial - Sent Appeal 2',
            'Resubmission: Underpayment',
            'Resubmission: Claim On File - Fax sent for claim status',
            'EOB Sent to payer'
          ]
        },
        followUpDays: {
          'Status check::Appeal: Appeal In Process - 1': 28,
          'Status check::Appeal: Appeal In Process - 2': 28,
          'Status check::No Action Taken: Claim In Process': 28,
          'Status check::No Action Taken: Claim Paid but EOB Not Received': 28,
          'Status check::Escalated To Onshore - Coding Review Needed': 7,
          'Status check::Escalated To Onshore - Credentialing Issues': 7,
          'Status check::Escalated To Onshore - Missing Medical Records': 7,
          'Status check::Escalated To Onshore - Needs Appeal': 7,
          'Status check::Escalated to Onshore - Patient Calling': 7,
          'Payment - To be Posted::No Action Taken: Payment Posted Prior to Status Check': 0,
          'Status check::Patient balance: Applied to Deductible/Copay/Co-Ins': 7,
          'Status check::Patient balance: Ins pymt sent to member': 7,
          'Status check::Payment to be Posted': 7,
          'Status check::Payment to be Posted: Partial Payment': 7,
          'Resubmit::Reprocessing: Coding Related Denial': 28,
          'Resubmit::Reprocessing: Credentialing Issues': 28,
          'Resubmit::Reprocessing: Missing Authorization': 28,
          'Resubmit::Reprocessing: Pmt Released but Never Received': 28,
          'Resubmit::Reprocessing: Underpayment': 28,
          'Resubmit::Resubmission :Claim on file - Coding Issue Fixed': 28,
          'Resubmit::Resubmission: Claim Filed with POTF': 28,
          'Resubmit::Resubmission: Claim Not on File - All Info Correct': 28,
          'Resubmit::Resubmission: Claim Not on File - Demographics Fixed': 28,
          'Resubmit::Resubmission: Claim Not on File - Insurance Info Fixed': 28,
          'Resubmit::Resubmission: Claim Not on File - Paper Claim Sent': 28,
          'Resubmit::Resubmission: Claim On File - Missing Insurance Info': 28,
          'Resubmit::Resubmission: Claim On File - Missing Medical Records': 28,
          'Resubmit::Resubmission: Denial - Credentialing Issues': 28,
          'Resubmit::Resubmission: Denial - Sent Appeal 1': 28,
          'Resubmit::Resubmission: Denial - Sent Appeal 2': 28,
          'Resubmit::Resubmission: Underpayment': 28,
          'Status check::Write Off: Eligibility': 0,
          'Status check::Write Off: Missing/Expired Authorization': 0,
          'Status check::Write Off: Non Billable Procedure or Non Covered Code': 0,
          'Status check::Write Off: Non-Credentialed Provider': 0,
          'Status check::Write Off: Timely Filing': 0,
          'Status check::No Action Taken: Escalated To Onshore - Incorrect Check Issue address and cashed': 0,
          'Status check::Escalated To Onshore - Primary Medicare EOB Needed.': 0,
          'Status check::Patient Balance: No OON Benefit': 0,
          'Status check::Patient Balance: Inactive Insurance': 0,
          'Status check::Reprocessing: Check reissued': 15,
          'Resubmit::Resubmission: Claim On File - Fax sent for claim status': 15,
          'Status check::Escalated To Posting - Incorrect Check Issue address and cashed': 0,
          'Status check::Reprocessing: Incorrectly processed/Denied': 15,
          'Status check::Escalated To Onshore - Unable to Obtain Remit': 0,
          'Status check::Paid Claim: Pending Payment due to EFT Issue': 15,
          'Status check::Billed to patient': 0,
          'Status check::Pending Insurance Follow up': 15,
          'Status check::Letter Sent to Patient': 0,
          'Status check::Adjustment Taken (Based on Guideline)': 0,
          'Resubmit::EOB Sent to payer': 15,
          'Status check::Sent to Posting Team': 0,
          'Payment - To be Posted::Claim Completed/Settled': 0,
          'Status check::Self Pay: No Active Insurance': 0,
          'Status check::Self Pay: Non-covered under plan benefit': 0,
          'Status check::Self Pay: Other Insurance Primary': 0,
          'Status check::Write Off: Duplicate': 0,
          'Status check::Escalated to Onshore: To Update Payer': 15,
          'Status check::Escalated to Onshore : Hospice/SNF': 15,
          'Status check::Escalated to Onshore : Referral Needed': 15,
          'Status check::Escalated to Onshore : New Insurance Info Needed': 15
        }
      });
    } catch (error) {
